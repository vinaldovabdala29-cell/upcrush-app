...
class PS {
  ...
  static const Map<String, Map<String, String>> _t = {
    ...
    'trial_sub': {
      'de': '3 Tage kostenlos, dann {price}/Woche. Jederzeit kündbar.',
      'es': '3 días gratis, luego {price}/sem. Cancela cuando quieras.',
      'fr': '3 jours gratuits, puis {price}/semaine. Annulable à tout moment.',
      'it': '3 giorni gratis, poi {price}/settimana.',
      'tr': '3 gün ücretsiz, sonra {price}/hafta.',
      'pl': '3 dni za darmo, potem {price}/tydzień.',
      'ru': '3 дня бесплатно, затем {price}/неделю.',
      'ar': '3 أيام مجاناً، ثم {price} أسبوعياً.',
      'en': '3 days free, then {price}/week. Cancel anytime.',
      'pt': '3 dias grátis, depois {price}/sem. Cancela quando quiseres.',
    },
    'plans_title': {
