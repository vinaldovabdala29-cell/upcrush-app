...
class _OpenerScreenState extends State<OpenerScreen>
    ...
    return Column(children: [
      Expanded(child: Stack(fit: StackFit.expand, children: [
        ...
        AnimatedBuilder(
          ...
          builder: (context, _) {
            ...
            return Positioned(
              top: 0, bottom: 0, left: _scanAnim.value * w,
      ...
      Container(
        ...
        child: Column(children: [
          AnimatedBuilder(
            ...
            builder: (_, __) => Opacity(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                const Text("AI analyzing profile...", style: TextStyle(
          ...
          Text(lang.screenshotAnalyzingSub, textAlign: TextAlign.center,
  ...
  Widget _buildErro(bool isDark, lang) {
